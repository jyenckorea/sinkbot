# 파일명: dashboard.py (v1.8 - 오류 수정 및 잔상 문제 최종 해결)
...
st.title("🛰️ SinkBot AI 관제 대시보드 (v1.8)")
                ...
                if 'delta_z' in df_processed.columns and len(df_processed) > 1:
                    ...
                    if manual_axis_control and not df_to_plot.empty:
                        ...
                        with axis_col1:
                            ...
                            user_start_date = st.date_input("시작 날짜:", value=min_date, min_value=min_date, max_value=max_date)
                            user_end_date = st.date_input("종료 날짜:", value=max_date, min_value=min_date, max_value=max_date)
                        ...
                        with axis_col2:
                            ...
                            user_min = st.number_input("최소값:", value=min_val, format="%.4f")
                            user_max = st.number_input("최대값:", value=max_val, format="%.4f")
